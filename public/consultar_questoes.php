...
// Carregar todas as disciplinas para preencher os <select>
$disciplinas_result = $conn->query("SELECT id_disciplina, nome FROM disciplinas");
$disciplinas = [];
while ($row = $disciplinas_result->fetch_assoc()) {
    $disciplinas[$row['id_disciplina']] = $row['nome'];
}
?>
    ...
    <div class="container mt-5">
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <?php
                // Consulta corrigida com JOIN para pegar o nome do assunto e da disciplina
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        foreach ($disciplinas as $id_disc => $nome_disc) {
                            $selected = $id_disc == $row['id_disciplina'] ? "selected" : "";
                            echo "<option value='$id_disc' $selected>$nome_disc</option>";
                        }
                        echo "</select>
                                </td>
                                <td>
