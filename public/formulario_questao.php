...
<body class="bg-light" style="height: 90vh; background-image: url(../assets/background.jpg); background-size: cover; background-position: center;">
        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <form action="carregar_assuntos.php" method="post">
                    <div class="mb-3">
                        <label for="pergunta" class="form-label"><h5>Pergunta:</h5></label>
                        <textarea name="pergunta" class="form-control" rows="5" required></textarea>
                    </div>

                    <div class="mb-3">
                        <label class="form-label"><h5>Disciplinas:</h5></label>
